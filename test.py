...
def modify_testfiles_fingerprint_2(timestamp:time):
    """
    >>> fp_files = FingerPrintFiles(fp_drive_path = './testfiles/', fp_result_fullpath = './' )
    >>> f_time = time.time()
    >>> create_testfiles_fingerprint_1(f_time)
    >>> fileinfo1_1 = fp_files.get_fileinfo('./testfiles/file1_no_changes.txt')
    >>> fileinfo1_3 = fp_files.get_fileinfo('./testfiles/file3_change_data.txt')
    >>> fileinfo1_4 = fp_files.get_fileinfo('./testfiles/file4_change_data_silently.txt')
    >>> fileinfo1_5 = fp_files.get_fileinfo('./testfiles/file5_change_creation_date.txt')
    >>> fileinfo1_6 = fp_files.get_fileinfo('./testfiles/file6_change_modified_date.txt')
    >>> fileinfo1_7 = fp_files.get_fileinfo('./testfiles/file7_change_accessed_date.txt')
    >>> modify_testfiles_fingerprint_2(f_time)
    >>> fileinfo2_1 = fp_files.get_fileinfo('./testfiles/file1_no_changes.txt')
    >>> fileinfo2_3 = fp_files.get_fileinfo('./testfiles/file3_change_data.txt')
    >>> fileinfo2_4 = fp_files.get_fileinfo('./testfiles/file4_change_data_silently.txt')
    >>> fileinfo2_5 = fp_files.get_fileinfo('./testfiles/file5_change_creation_date.txt')
    >>> fileinfo2_6 = fp_files.get_fileinfo('./testfiles/file6_change_modified_date.txt')
    >>> fileinfo2_7 = fp_files.get_fileinfo('./testfiles/file7_change_accessed_date.txt')
