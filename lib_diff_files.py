...
class FileDiff(object):
    def __init__(self,
        ...
        self.fingerprint_files_1 = FingerPrintFiles(fingerprint_name=fingerprint_name_1,
                                                    ...
                                                    fingerprint_drive=fingerprint_drive)
    ...
    def create_diff_file(self):
        """
        :return:
        >>> file_diff = FileDiff(fingerprint_name_1='test', fingerprint_name_2='test', fingerprint_result_dir='c:/test', fingerprint_drive='c:/')
    ...
    def read_file_fingerprint_1(self)->{}:
        ...
        >>> file_diff = FileDiff(fingerprint_name_1='test', fingerprint_name_2='test2', fingerprint_result_dir='c:/test', fingerprint_drive='c:/')
